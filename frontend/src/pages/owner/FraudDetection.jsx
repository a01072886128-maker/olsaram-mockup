  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        // 통계값 세팅
        setStats({
          blockedThisMonth: data.blockedThisMonth,
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        <Alert className="mb-6 border-orange-200 bg-orange-50">
          ...
          <AlertDescription className="text-orange-900">
            <strong>주의!</strong> {stats.blockedThisMonth}건의 사기 의심 예약이
            자동 차단되었습니다.
          </AlertDescription>
        </Alert>
          ...
          <Card className="border-slate-200">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-green-600">
                {(stats.savedAmount / 10000).toFixed(0)}만원
              </div>
            </CardContent>
          </Card>
                      ...
                      <div>
                        <div className="mb-1 flex items-center gap-2">
                          <span className="text-lg font-semibold">
                            {reservation.customerName}님 결과
                          </span>
                          <Badge className={style.badge}>
                            {riskLabels[reservation.riskLevel]}
                          </Badge>
                          <span className="text-sm text-slate-600">
                            위험도: {reservation.riskScore}점
                          </span>
                        </div>
                        <p className="text-sm text-slate-600">
                          {reservation.requestedDate} · {reservation.partySize}
                          명 예약 시도
                        </p>
                      </div>
