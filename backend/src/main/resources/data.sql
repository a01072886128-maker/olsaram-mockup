...
VALUES ('owner1', '$2a$10$xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', '테스트 사장', '01012345678', 'owner1@test.com', '1234567890', true, 'FREE', 1, NOW(), NOW());

-- 테스트 고객 계정 생성
INSERT IGNORE INTO customer (login_id, password, name, phone, email, created_at, updated_at)
VALUES ('customer1', '$2a$10$xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', '테스트 고객', '01087654321', 'customer1@test.com', NOW(), NOW());
